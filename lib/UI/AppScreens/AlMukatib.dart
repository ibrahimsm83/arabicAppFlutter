...
class AlMukatib extends StatefulWidget {
  @override
  _AlMukatibState createState() => _AlMukatibState();
}
class  _AlMukatibState extends State<AlMukatib> {
  @override
  void initState() {
                          ...
                          Container(
                            ...
                            child: RaisedButton(
                              ...
                              onPressed: () {
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) =>ScreenNo20()),
                                );
